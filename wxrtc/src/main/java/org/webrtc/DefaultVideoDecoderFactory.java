  ...
  public VideoCodecInfo[] getSupportedCodecs() {
    ...
    if (this.platformSoftwareVideoDecoderFactory != null)
      supportedCodecInfos.addAll(
          Arrays.asList(this.platformSoftwareVideoDecoderFactory.getSupportedCodecs())); 
    return (VideoCodecInfo[])supportedCodecInfos.toArray((Object[])new VideoCodecInfo[supportedCodecInfos.size()]);
  }
}
