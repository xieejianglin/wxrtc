...
abstract class WXRTC {
    ...
    protected var mRoomId: String? = null
    ...
    abstract fun init(context: PlatformContext)
    ...
    abstract fun startLocalPreview(frontCamera: Boolean, view: RTCVideoContainerView?)

    abstract fun updateLocalView(view: RTCVideoContainerView?)

    abstract fun stopLocalPreview()

    abstract fun muteLocalVideo(mute: Boolean)

    abstract fun startRemoteView(userId: String, view: RTCVideoContainerView?)

    abstract fun updateRemoteView(userId: String, view: RTCVideoContainerView?)

    abstract fun stopRemoteView(userId: String)

    abstract fun stopAllRemoteView()
    ...
    abstract fun startScreenCapture(encParam: WXRTCVideoEncParam?, renderer: RTCVideoContainerView?)
