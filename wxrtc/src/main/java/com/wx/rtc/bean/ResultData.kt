...
class ResultData {
    var rst: Int = 0 //0 没有关心的物体  1 气囊 2 温度计 3条形码 4二维码 5血压仪 6腰椎穿刺 7眼科标记 8人脸 9语音识别
    var need_focus: Int = 0 //1表示需要聚焦，0表示不需要聚焦
    var focus_point: List<Float>? = null //聚焦位置
    var drop_speed: String? = null //滴速,单位 滴/秒
    var scale: String? = null //体温度数
    var need_magnify: Int = 0 // 0表示不需要放大,1表示需要放大
