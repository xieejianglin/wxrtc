...
import com.wx.rtc.utils.setSpeakerOn
...
class WXRTCImpl : WXRTC(), SocketListener, RTCListener {
    ...
    override fun startLocalPreview(frontCamera: Boolean, view: RTCVideoContainerView?) {
        view?.setVisible(true)
        mRTCManager.startLocalPreview(frontCamera, view)
    ...
    override fun updateLocalView(view: RTCVideoContainerView?) {
        view?.setVisible(true)
        mRTCManager.updateLocalView(view)
    }

    override fun stopLocalPreview() {
        mRTCManager.stopLocalPreview()
    ...
    override fun startRemoteView(userId: String, view: RTCVideoContainerView?) {
        view?.setVisible(true)
        mRTCManager.startRemoteView(userId, view)
    }

    override fun updateRemoteView(userId: String, view: RTCVideoContainerView?) {
        view?.setVisible(true)
        mRTCManager.updateRemoteView(userId, view)
    }

    override fun stopRemoteView(userId: String) {
        mRTCManager.stopRemoteView(userId)
    }

    override fun stopAllRemoteView() {
        mRTCManager.stopAllRemoteView()
    }
    ...
    override fun startScreenCapture(encParam: WXRTCVideoEncParam?, renderer: RTCVideoContainerView?) {
    ...
    override fun setSpeakerOn(speakerOn: Boolean) {
        ...
        setSpeakerOn(mContext!!, speakerOn)
    }
    ...
    companion object {
        private val TAG: String = WXRTCImpl::class.simpleName ?: "WXRTCImpl"
